...
// System.out.println("********** id produit supposé 1 : "+ListViewTestController.LoggedUser.getId_produit());
    ...
    public void ajouterCommentaire(ActionEvent event){
        CommentaireService cs = new CommentaireService() ;
        Commentaire c = new Commentaire(ListViewTestController.LoggedUser.getId_produit(), 1, commentaire.getText()) ; //AuthentificationController.LoggedParent.getId_user()
        cs.insert(c);
        afficherCommment(); 
    }
